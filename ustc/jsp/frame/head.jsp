...
<TABLE cellSpacing=0 cellPadding=0 width=778 align=center border=0>
  ...
  <TR>
    <TD align=right background='<%=request.getContextPath()%>/ustc/html/pic/line.jpg'>&nbsp;&nbsp;<font color=green>欢迎<% if("1".equals(isCorrectUserTicket)) {%><font color=red><b>SchAdmin</b></font><%}%>使用大学学籍管理系统</font></TD>
  </TR>
  <TR>
